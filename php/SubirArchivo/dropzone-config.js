Dropzone.options.subirImagen = {    
    ...
    maxFilesize: 10, //Maximo Tama�o del archivo expresado en mg
    ...
    filesizeBase: 1000,
    maxFiles: null,//si no es nulo, define cu�ntos archivos se cargaRAN. Si se excede, se llamar� el EVENTO maxfilesexceeded.
